...
public class ColorsActivity extends AppCompatActivity {
    ...
    // listener is triggered when the audio focus changes. if statements change apps response according
    // to what type of change (gain focus, lose focus, etc.)
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(ColorsActivity.this, words.get(i).getmAudioFileId());
                    mMediaPlayer.start();
